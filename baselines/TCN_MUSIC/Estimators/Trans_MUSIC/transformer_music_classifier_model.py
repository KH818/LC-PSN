"""Attach a source-count classifier to the fitted Trans-MUSIC regressor features."""

import torch.cuda
import torch.nn as nn


class TransMUSICClassifierModel(nn.Module):
    def __init__(self,
                 regressor_model,
                 device=torch.device("cuda" if torch.cuda.is_available() else "cpu"),
                 ):
        super(TransMUSICClassifierModel, self).__init__()
